        ...
        <form method="post" action="{{ route('LaravelInstaller::licenseCheck') }}" class="tabs-wrap">
            ...
            <div>
                <div class="form-group {{ $errors->has('email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="email" id="email" value="username@email.com" placeholder="Your Mail Address" />
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="purchase_code" id="purchase_code" value="0d487bc4-e788-48d3-9451-bbf62c09fcf0" placeholder="Your Item Purchase Code" />
